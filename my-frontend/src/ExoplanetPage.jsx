...
function ExoplanetPage() {
  // Constants from the second page for header and nav height
  const HEADER_H = 96;
  const NAV_H = 50;
  const FIXED_OFFSET = HEADER_H + NAV_H; // Total height of fixed elements

  useEffect(() => {
    // Keep the member-blue class applied to the body
